...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // Tighter scale tuned for Plus Jakarta Sans's x-height
        "2xs": ["0.6875rem", { lineHeight: "1rem" }],    // 11px
        "xs":  ["0.75rem",   { lineHeight: "1.1rem" }],  // 12px
        "sm":  ["0.8125rem", { lineHeight: "1.25rem" }], // 13px
        "base":["0.9375rem", { lineHeight: "1.6rem" }],  // 15px — slightly larger base
        "lg":  ["1.0625rem", { lineHeight: "1.6rem" }],  // 17px
        "xl":  ["1.1875rem", { lineHeight: "1.5rem" }],  // 19px
        "2xl": ["1.375rem",  { lineHeight: "1.35rem" }], // 22px
        "3xl": ["1.625rem",  { lineHeight: "1.25rem" }], // 26px
        "4xl": ["2rem",      { lineHeight: "1.15rem" }], // 32px
        "5xl": ["2.5rem",    { lineHeight: "1.1rem" }],  // 40px
        "6xl": ["3.125rem",  { lineHeight: "1.05rem" }], // 50px
      },
