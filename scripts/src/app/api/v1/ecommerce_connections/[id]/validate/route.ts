...
async function validateBigCommerce(storeHash: string, token: string) {
  try {
...
export async function GET(req: Request, context: any) {
  // normalize params (Next context.params may be a Promise)
  ...
  try {
    ...
    const test = await validateBigCommerce(storeHash, token);
