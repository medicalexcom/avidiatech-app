...
function SpecsPanel({
  ...
  return (
    <JsonScrollPanel tone="dark">
      <pre className="p-3 text-[12px] leading-5 text-slate-50 whitespace-pre-wrap break-words">
...
function DiagnosticsPanel({
  ...
  return (
    <JsonScrollPanel tone="amber">
      <pre className="p-3 text-[12px] leading-5 text-amber-50 whitespace-pre-wrap break-words">
