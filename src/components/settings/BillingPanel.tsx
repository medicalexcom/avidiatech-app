  ...
  return (
    <div className="max-w-4xl space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 rounded-2xl border border-slate-200/60 bg-slate-50/60 px-4 py-3 dark:border-slate-800/60 dark:bg-slate-900/50">
        ...
        <span className="h-3 w-px bg-slate-200 dark:bg-slate-700" />
        <a href="/privacy" className="text-[11.5px] text-slate-400 underline-offset-2 transition hover:text-slate-600 hover:underline dark:text-slate-500 dark:hover:text-slate-300">
          Privacy policy
        </a>
      </div>
    </div>
