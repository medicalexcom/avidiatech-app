              ...
              return (
                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    <span className={`shrink-0 rounded-md px-2 py-0.5 text-[12px] font-semibold uppercase tracking-wide ${variantCls[variant]}`}>
                      {l.status}
                    </span>
                  ...
                  <div className="flex shrink-0 items-center gap-4 text-[12px] text-slate-400 dark:text-slate-500">
