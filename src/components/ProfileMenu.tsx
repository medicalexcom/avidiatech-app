 ...
 * - Keeps menu minimal and links organization to a single org settings page.
 */
...
export default function ProfileMenu() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const effectiveDark = saved === "dark" || ctxTheme === "dark" || rootHasDark;
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-3.5 border-b border-slate-200/80 dark:border-slate-800/80">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-1 text-[12px] text-slate-500 dark:text-slate-400">
            {orgName ? (
              <>
                <span className="font-medium text-slate-800 dark:text-slate-200">{orgName}</span>{" "}
      ...
      <div className="mt-1 border-t border-slate-100 dark:border-slate-800 px-4 py-3 space-y-3">
        <div className="flex items-center justify-between gap-3">
          <div>
            <div className="text-sm font-medium text-slate-900 dark:text-slate-50">Appearance</div>
          </div>
          ...
          {mounted && (
            <button
              ...
              className={[
                "inline-flex items-center rounded-full border px-1 py-0.5 text-[12px] font-medium shadow-sm transition-colors",
