    ...
    <div className="text-xs text-neutral-50">
      ...
      <div className="flex items-center justify-between gap-2 mb-2">
        <div className="flex items-center gap-2">
          <span className="text-[12px] uppercase tracking-wide text-neutral-400">
            Root
          </span>
          <code className="px-1.5 py-0.5 rounded bg-neutral-800 border border-neutral-700 text-[12px]">
            {effectiveLabel}
          </code>
        </div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="bg-neutral-900 border border-neutral-700 rounded px-2 py-1 text-[12px] text-neutral-100 placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-sky-500"
          />
          {envelope && (
            <button
              type="button"
          ...
          <button
            type="button"
            onClick={handleCopy}
            className="px-2 py-1 rounded text-[12px] border bg-neutral-900 text-neutral-100 border-neutral-700 hover:bg-neutral-800"
          >
