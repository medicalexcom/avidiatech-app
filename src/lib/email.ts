              ...
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="vertical-align:middle;padding-right:10px;">
                    <!-- Diamond-chevron mark (inline SVG — renders in Gmail, Apple Mail, Outlook 365) -->
                    <svg width="36" height="36" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;">
                      ...
                      <rect x="3.8" y="3.8" width="24.4" height="24.4" rx="4.5" transform="rotate(45 16 16)" fill="url(#eg)"/>
                      <path d="M8.5 12.5L13.5 16L8.5 19.5" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M13.5 12.5L18.5 16L13.5 19.5" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M18.5 12.5L23.5 16L18.5 19.5" stroke="rgba(255,255,255,0.38)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                  </td>
