        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
          ...
          <tr>
            <td style="padding:28px 32px 0;">
              <span style="font-size:18px;font-weight:700;color:#1e293b;letter-spacing:-0.5px;">AvidiaTech</span>
              <span style="font-size:11px;color:#64748b;margin-left:8px;">Product Data Automation</span>
            </td>
          </tr>
          <!-- Body -->
          <tr>
