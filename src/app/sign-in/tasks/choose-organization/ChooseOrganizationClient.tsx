...
export default function ChooseOrganizationClient() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center p-6 bg-slate-50 dark:bg-[#09090b] overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/4 h-[400px] w-[400px] rounded-full bg-indigo-400/10 dark:bg-indigo-500/10 blur-[100px]" />
        <div className="absolute bottom-0 right-1/4 h-[300px] w-[300px] rounded-full bg-violet-400/8 dark:bg-cyan-500/8 blur-[100px]" />
      ...
      <div className="relative w-full max-w-md p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-lg dark:shadow-2xl">
        <h2 className="text-xl font-semibold mb-4 text-slate-900 dark:text-slate-100">Choose an organization</h2>
