...
export default function SignInPage() {
  ...
  const redirect =
    params?.get("redirect") ?? params?.get("redirect_url") ?? "/dashboard";
        ...
        {!clerkFailed ? (
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-600">
              We couldn't load the sign-in widget. You can try one of the
              options below:
            </p>
            ...
            <div className="mt-3 text-xs text-slate-500">
              <p>
                If this persists, please check the browser console or paste the
                Clerk error below for help:
              </p>
