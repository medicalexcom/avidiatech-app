    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 flex flex-col items-center gap-2">
          ...
          <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400">AvidiaTech</p>
        </div>
          ...
          {!isSignedIn ? (
            ...
            <div className="mt-6 space-y-5">
              ...
              <div className="space-y-2">
                <label className="text-[12px] font-semibold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-400">
                  Choose plan
                </label>
                <div className="space-y-2">
                  {plans.map((p) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className={`text-[13px] font-semibold ${plan === p.value ? "text-cyan-700 dark:text-cyan-300" : "text-slate-600 dark:text-slate-300"}`}>
                          {p.price}
                        </p>
