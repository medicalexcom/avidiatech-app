            ...
            <div className="mt-6 space-y-5">
                  ...
                  {plans.map((p) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[12px] text-slate-400">after trial</p>
                      </div>
                    </button>
                  ))}
                </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="flex items-center gap-3 text-[10.5px]">
                  <a href="/legal/privacy" className="text-slate-500 underline-offset-2 hover:text-slate-300 hover:underline transition">Privacy policy</a>
                  <span className="text-slate-700">·</span>
                  <a href="/legal/terms" className="text-slate-500 underline-offset-2 hover:text-slate-300 hover:underline transition">Terms of service</a>
                </div>
              </div>
            </div>
          )}
