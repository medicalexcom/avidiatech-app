  ...
  return (
    <div className="relative min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 right-1/4 h-[400px] w-[400px] rounded-full bg-cyan-400/8 dark:bg-cyan-500/8 blur-[120px]" />
        <div className="absolute bottom-0 left-1/4 h-[300px] w-[300px] rounded-full bg-emerald-400/8 dark:bg-emerald-500/8 blur-[100px]" />
      ...
      <header className="mb-6">
        <h1 className="text-3xl font-semibold text-slate-900 dark:text-slate-50">Integrations</h1>
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Connect AvidiaTech to your store and data sources.</p>
      </header>

      <div className="grid grid-cols-12 gap-6">
        <section className="col-span-8">
          <div className="mb-4">
            <h2 className="text-xl font-medium text-slate-900 dark:text-slate-50">Connected integrations</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400">Active connections for this tenant</p>
          </div>
        ...
        <aside className="col-span-4">
          <div className="mb-4">
            <h3 className="text-lg font-medium text-slate-900 dark:text-slate-50">Available integrations</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400">Select a provider to get started</p>
          </div>
