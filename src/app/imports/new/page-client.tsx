  ...
  return (
    <main className="dark relative flex min-h-screen items-center justify-center bg-slate-950 px-4 py-12 overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/4 h-[400px] w-[400px] rounded-full bg-emerald-500/10 blur-[100px]" />
      ...
      <div className="w-full max-w-xl">
        <div className="relative rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-2xl">
          <h1 className="text-xl font-semibold mb-3 text-slate-100">Create import</h1>
