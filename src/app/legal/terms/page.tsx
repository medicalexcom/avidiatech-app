  ...
  return (
    <div className="dark relative min-h-[100dvh] bg-slate-950 text-slate-50 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-cyan-500/12 blur-[120px]" />
        <div className="absolute bottom-0 -left-20 h-80 w-80 rounded-full bg-sky-500/10 blur-[100px]" />
        <div
      ...
      {/* Top gradient stripe */}
      <div className="absolute top-0 left-0 right-0 h-[3px]" style={{ background: "linear-gradient(90deg,#06b6d4 0%,#0ea5e9 100%)" }} />
