...
export default function PrivacyPage() {
  return (
    <div className="dark relative min-h-[100dvh] bg-slate-950 text-slate-50 overflow-hidden">
      {/* Ambient glow */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-violet-500/12 blur-[120px]" />
        <div className="absolute bottom-0 -left-20 h-80 w-80 rounded-full bg-indigo-500/10 blur-[100px]" />
        <div
      ...
      {/* Top gradient stripe */}
      <div className="absolute top-0 left-0 right-0 h-[3px]" style={{ background: "linear-gradient(90deg,#8b5cf6 0%,#6366f1 100%)" }} />
        ...
        <div className="space-y-10 text-sm leading-7 text-slate-700 dark:text-slate-300">
          ...
          <section>
            ...
            <div className="mt-4 rounded-lg border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
              <p className="font-semibold text-slate-50">AvidiaTech, Inc.</p>
