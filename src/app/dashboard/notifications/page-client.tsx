        ...
        <section className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            <div key={s.label} className="rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-1 text-[12px] text-slate-400 dark:text-slate-500">{s.sub}</p>
            </div>
          ))}
        </section>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className={`rounded-full border px-2 py-0.5 text-[12px] font-semibold uppercase ${SEVERITY_STYLES[n.severity]}`}>
                        {n.severity}
                      </span>
                    ...
                    <p className="mt-1 text-[12px] text-slate-400 dark:text-slate-600">{fmtDate(n.ts)}</p>
                  </div>
                  {!n.read && (
                      ...
                      <div className="flex flex-wrap items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <span className={`rounded-full border px-2 py-0.5 text-[12px] font-semibold uppercase ${SEVERITY_STYLES[rule.severity]}`}>
                              {rule.severity}
                            </span>
                          </div>
