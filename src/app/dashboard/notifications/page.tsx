...
const SAMPLE_NOTIFICATIONS: NotificationItem[] = [
  {
    ...
    body: "Medline CSV import finished: 412 succeeded, 3 failed.",
    severity: "info",
    category: "Ingestion",
    ts: "2025-04-04T14:30:00Z",
    read: false,
  },
  {
    id: "n2",
    title: "Price change detected",
    body: "McKesson IV Pole (MCKIVP-4): $89.99 → $97.49 (+8.3%)",
    severity: "warning",
    category: "Monitor",
    ts: "2025-04-04T11:15:00Z",
    read: false,
  },
  {
    id: "n3",
    title: "Audit blocker found",
    body: "Drive Medical Rollator Walker is missing required compliance fields.",
    severity: "critical",
    category: "Audit",
    ts: "2025-04-03T16:42:00Z",
    read: true,
  },
  {
    id: "n4",
    title: "Quota at 81%",
    body: "Your workspace has used 810 of 1,000 monthly ingestion credits.",
    severity: "warning",
    category: "Quota",
    ts: "2025-04-03T09:00:00Z",
    read: true,
  },
  {
    id: "n5",
    title: "Export ready",
    body: "BigCommerce import job for 128 products is ready to push.",
    severity: "info",
    category: "Import",
    ts: "2025-04-02T18:20:00Z",
    read: true,
  },
];
