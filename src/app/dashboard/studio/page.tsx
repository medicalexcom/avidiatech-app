  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-40 -left-24 h-80 w-80 rounded-full bg-fuchsia-500/20 blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 lg:px-8 py-8 space-y-6">
        {/* HERO ROW */}
        <section className="relative overflow-hidden rounded-3xl border border-fuchsia-500/40 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 shadow-[0_0_80px_rgba(236,72,153,0.45)] px-5 py-6 lg:px-7 lg:py-7">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
            {/* Left copy */}
            <div className="flex-1 min-w-[260px] space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full bg-slate-950/90 border border-fuchsia-500/60 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.18em] text-slate-300">
                <span className="inline-flex h-3 w-3 items-center justify-center rounded-full bg-slate-900 border border-fuchsia-400/80">
                  <span className="h-1.5 w-1.5 rounded-full bg-fuchsia-400 animate-pulse" />
                </span>
                AvidiaStudio • Page designer
                <span className="h-1 w-px bg-slate-600" />
                <span className="rounded-full bg-amber-500/15 px-2 py-[2px] text-[9px] font-semibold text-amber-200 border border-amber-400/40">
                  Coming soon
                </span>
              </div>
              ...
              <div className="space-y-2">
                <h1 className="text-2xl lg:text-3xl font-semibold leading-tight text-slate-50">
                  Design{" "}
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-300 via-cyan-300 to-sky-300">
              ...
              <div className="flex flex-wrap gap-3 text-[11px]">
                ...
                <div className="inline-flex items-center gap-2 rounded-full bg-slate-950/90 border border-sky-500/40 px-3 py-1.5">
              ...
              <div className="rounded-2xl bg-slate-950/95 border border-slate-800/80 px-4 py-4 space-y-3">
                ...
                <div className="space-y-2 text-[11px]">
                  {templatePresets.map((tpl) => (
                    <div
                      key={tpl.name}
                      className="rounded-xl bg-slate-900/90 border border-slate-800 px-3 py-2.5 flex flex-col gap-1"
                    >
                      <div className="flex items-center justify-between gap-2">
                        <span className="font-semibold text-slate-100">
                          {tpl.name}
                        </span>
                        <span className="inline-flex items-center rounded-full bg-slate-950/90 border border-slate-700 px-2 py-[2px] text-[9px] text-slate-300">
                          Preset
                        </span>
                      </div>
          ...
          <div className="rounded-2xl bg-slate-900/90 border border-slate-800/80 p-4 lg:p-5 space-y-4">
            ...
            <form className="space-y-3 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  className="w-full rounded-lg border border-slate-700 bg-slate-950/80 px-3 py-2 text-xs text-slate-100 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/40 focus:border-fuchsia-400"
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {layoutBlocks.map((label, index) => (
                    <label
                      key={label}
                      className="flex items-center gap-2 rounded-lg border border-slate-700 bg-slate-950/80 px-3 py-1.5 hover:border-fuchsia-500/40 hover:bg-slate-900/90 cursor-pointer"
                    >
                      <input
                        type="checkbox"
                        defaultChecked={index < 4}
                        className="h-3 w-3 rounded border border-slate-500 bg-slate-900 text-fuchsia-400 focus:ring-fuchsia-500/40"
                      />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <select
                    className="w-full rounded-lg border border-slate-700 bg-slate-950/80 px-3 py-2 text-xs text-slate-100 focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-cyan-400"
                    defaultValue="add"
                  >
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <button
                  type="button"
                  className="inline-flex items-center gap-1.5 rounded-lg bg-fuchsia-500 px-3.5 py-2 text-xs font-semibold text-slate-950 shadow-md shadow-fuchsia-500/40 hover:bg-fuchsia-400 hover:-translate-y-[1px] transition"
                >
                  Apply layout to preview
                </button>
                <button
                  type="button"
                  className="inline-flex items-center gap-1.5 rounded-lg bg-slate-950/90 border border-slate-700 px-3.5 py-2 text-xs font-semibold text-slate-200 hover:border-sky-400/60 hover:text-sky-100 hover:bg-slate-900/90 transition"
                >
          ...
          <div className="rounded-2xl bg-slate-900/90 border border-slate-800/80 p-4 lg:p-5 space-y-4">
            <header className="flex items-start justify-between gap-3">
              ...
              <div className="flex flex-col items-end gap-1 text-[10px] text-slate-400">
                <div className="inline-flex items-center gap-1 rounded-full bg-slate-950/90 border border-slate-700 px-2 py-[2px]">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-400" />
                  <span>Preview only</span>
                </div>
                <div className="flex gap-1">
                  <span className="inline-flex h-6 w-8 items-center justify-center rounded-md bg-slate-900 border border-slate-700 text-[10px]">
                    ▯
                  </span>
                  <span className="inline-flex h-6 w-8 items-center justify-center rounded-md bg-slate-900 border border-slate-700 text-[10px]">
                    ▮
            ...
            {/* Mocked page preview */}
            <div className="rounded-2xl bg-slate-50 text-slate-900 border border-slate-200 overflow-hidden shadow-inner">
              {/* Top bar */}
              ...
              <div className="px-5 py-4 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1.2fr),minmax(0,0.9fr)] gap-4 md:gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      ...
                      <button className="inline-flex items-center justify-center rounded-md bg-slate-900 px-3.5 py-2 text-xs font-semibold text-slate-50">
                        View manuals & downloads
                      </button>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2">
                    <div className="flex-1 rounded-xl bg-slate-200 border border-slate-300 flex items-center justify-center text-[11px] text-slate-500">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {Array.from({ length: 3 }).map((_, i) => (
                        <div
                          key={i}
                          className="h-14 rounded-lg bg-slate-200 border border-slate-300"
                        />
                      ))}
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2 border-t border-slate-200 mt-3">
