            ...
            <div className="mt-1 w-full max-w-xs space-y-3 lg:mt-0 lg:max-w-sm">
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-violet-600 dark:text-violet-200">
                        REST API active · SDK in beta
                      </span>
                    </div>
                  </div>
                  <span className="inline-flex items-center rounded-full border border-slate-200 bg-slate-50 px-2.5 py-0.5 text-[12px] text-slate-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300">
                    API-first
                  </span>
                </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-3 py-3 shadow-[0_18px_45px_rgba(148,163,184,0.4)] dark:border-slate-800 dark:bg-slate-950/90 dark:shadow-[0_18px_45px_rgba(15,23,42,0.75)]">
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <span className="rounded-full border border-slate-200 bg-white px-2 py-0.5 text-[12px] text-slate-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-400">
                    REST · JSON
                  </span>
                </div>
                <pre className="overflow-auto rounded-xl border border-slate-200 bg-slate-900/95 px-3 py-2 text-[12px] leading-relaxed text-slate-100 dark:border-slate-800 dark:bg-slate-950/90 dark:text-slate-300">
...

{
  ...
  "tenant_id": "tenant_x"
                ...
                <p className="mt-2 text-[12px] text-slate-500 dark:text-slate-500">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/95 p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900/85">
              ...
              <div className="mt-3 grid gap-3 text-xs text-slate-600 sm:grid-cols-2 dark:text-slate-300">
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/70">
                  <div className="text-[12px] font-semibold uppercase tracking-wide text-violet-500 dark:text-violet-300">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/95 p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900/85">
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-violet-500 px-4 py-2 text-sm font-semibold text-slate-50 shadow-[0_12px_32px_rgba(167,139,250,0.35)] hover:bg-violet-400 dark:text-slate-950 dark:shadow-[0_12px_32px_rgba(167,139,250,0.55)]"
                >
                  Manage API keys &amp; docs →
                </a>
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Create keys, set scopes, copy live code examples, and view request logs
