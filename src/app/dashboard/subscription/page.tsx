    ...
    <PageShell glow="violet">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-slate-200/80 bg-white/90 p-5 shadow-card dark:border-slate-800 dark:bg-slate-900/80">
          <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">Plan</p>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white/90 p-5 shadow-card dark:border-slate-800 dark:bg-slate-900/80">
          <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">Role</p>
          ...
          {quotaDisplay.map((item) => {
            ...
            return (
              <div key={item.key} className="space-y-2">
                ...
                {exceeded && (
                  <p className="text-[11px] text-red-600 dark:text-red-400">Quota exceeded — upgrade to continue</p>
                )}
              </div>
            );
          })}
