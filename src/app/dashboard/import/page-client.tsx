...
export default function ImportPage() {
  ...
  /* Updated loadConnectors -> tries /api/v1/integrations first, falls back to /api/v1/ecommerce_connections */
      ...
      `}</style>
        ...
        <section className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-2">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/90 px-3 py-1.5 text-[12px] font-medium uppercase tracking-[0.18em] text-slate-600 shadow-sm">
              ...
              {ingestionIdInput ? (
                <>
                  ...
                  <span className="font-mono text-[12px]">{String(ingestionIdInput).slice(0, 8)}…</span>
                </>
              ) : null}
              {pipelineRunId ? (
                <>
                  <span className="h-3 w-px bg-slate-300/70 dark:bg-slate-700/70" />
                  <span className="font-mono text-[12px]">run:{String(pipelineRunId).slice(0, 8)}…</span>
                </>
              ) : null}
            </div>
            ...
            <aside className="lg:col-span-4">
              <div className="rounded-3xl border border-slate-200 bg-gradient-to-b from-white/95 to-slate-50/70 p-4 shadow-sm dark:border-slate-800 dark:from-slate-950/35">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={cx("inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/70 px-3 py-1 text-[12px] text-slate-600 shadow-sm dark:border-slate-800 dark:bg-slate-950/35")}>
                    ...
                    <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/70 px-3 py-1 text-[12px] text-slate-600 shadow-sm dark:border-slate-800 dark:bg-slate-950/35">
            ...
            <div className="lg:col-span-8 space-y-4">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <a href="/imports/new" className={cx(btnGhost, "h-9 px-3 text-xs")}>
                    Import history
                  </a>
                </div>
              </div>
                        ...
                        {mappingPreset ? (
                          <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs dark:border-slate-800 dark:bg-slate-950/50">
                            ...
                            <button
                              ...
                              className="rounded-full border border-slate-200 bg-white px-2 py-0.5 text-[12px] hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950/60 dark:hover:bg-slate-950"
                            >
                              Clear
                            </button>
                          </div>
          ...
          <div className="p-4 lg:p-5">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <pre className="max-h-[340px] overflow-auto rounded-2xl border border-slate-800 bg-slate-900/95 p-3 text-[12px] text-slate-100 dark:bg-slate-950/70">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white/92 backdrop-blur dark:border-slate-800 dark:bg-slate-950/55">
          <div className="p-4 lg:p-5">
            ...
            <pre className="mt-3 max-h-[360px] overflow-auto rounded-2xl border border-slate-800 bg-slate-900/95 p-3 text-[12px] text-slate-100 dark:bg-slate-950/70">
