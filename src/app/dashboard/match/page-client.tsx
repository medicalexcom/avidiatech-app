    ...
    return (
      <div className="flex flex-1 items-center justify-center p-6">
        <div className="max-w-lg rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <p className="text-[13px] text-slate-600 dark:text-slate-400">AvidiaMatch is not enabled for your plan.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="rounded-2xl border bg-white p-3">
            ...
            <div className="mt-2 space-y-2">
              ...
              <div className="rounded-lg border bg-slate-50 p-2 text-xs text-slate-700">
                ...
                <div className="mt-1 font-mono text-[12px] text-slate-600">Example headers: Supplier Name,SKU,Product Name</div>
              </div>
          ...
          <div className="rounded-xl border p-2 bg-white">
            ...
            <div className="mt-2 space-y-1.5">
              <button
                ...
                className="w-full rounded-lg bg-cyan-600 px-3 py-1.5 text-sm font-semibold text-white transition hover:bg-cyan-500 disabled:opacity-60"
              >
