      ...
      <PageShell glow="amber">
          ...
          <section className="mb-2 flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="space-y-4 max-w-2xl flex-1 min-w-[260px]">
              <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/90 px-3 py-1 text-[12px] font-medium uppercase tracking-[0.18em] text-slate-500 shadow-sm dark:bg-slate-900/70 dark:border-slate-800">
            ...
            <div className="w-full max-w-xs lg:max-w-sm mt-1 lg:mt-0 space-y-3">
              <div className="rounded-2xl border border-slate-200 bg-white/95 px-4 py-3 sm:px-5 sm:py-4 space-y-3 shadow-md dark:border-slate-800 dark:bg-slate-950/90">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <p className="text-[12px] font-medium uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">Module status</p>
                  ...
                  <span className="inline-flex items-center rounded-full bg-slate-50 border border-slate-200 px-2.5 py-0.5 text-[12px] text-slate-600 shadow-sm dark:bg-slate-900 dark:border-slate-700">
                    Pricing engine
                  </span>
                </div>
                <p className="text-[12px] text-slate-600 dark:text-slate-400">Compute → approve → push. Import will honor store_price when present.</p>
              </div>
            </div>
          </section>
