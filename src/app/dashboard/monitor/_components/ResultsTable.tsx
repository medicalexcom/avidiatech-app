  ...
  return (
    <section className="mt-4 rounded-2xl border border-slate-200 bg-white/60 p-4 text-sm shadow-sm dark:border-slate-800 dark:bg-slate-950/70">
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        {hasResults && (
          <span className="inline-flex items-center rounded-full bg-slate-900 px-2.5 py-1 text-[12px] font-medium text-slate-50 dark:bg-slate-100 dark:text-slate-900">
        ...
        <div className="overflow-hidden rounded-xl border border-slate-200 bg-slate-50/60 dark:border-slate-800 dark:bg-slate-900/40">
          <div className="max-h-[420px] overflow-auto">
            <table className="min-w-full border-collapse text-xs">
              <thead className="sticky top-0 bg-slate-100/90 text-[12px] uppercase tracking-[0.14em] text-slate-500 dark:bg-slate-900/90 dark:text-slate-400">
                <tr>
