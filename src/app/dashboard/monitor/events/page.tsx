  ...
  return (
    ...
    >
      ...
      <div className="relative min-w-0">
        <div className="truncate text-[12px] font-medium tracking-[0.02em] text-slate-600 dark:text-slate-300">
          {label}
        </div>
        ...
        {sub ? (
          <div className="mt-2">
            <span className="block truncate whitespace-nowrap text-[12px] leading-none text-slate-500 dark:text-slate-400">
              {sub}
            </span>
          </div>
        ) : null}
