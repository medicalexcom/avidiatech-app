...
function TinyChip({
  ...
  return (
    <span
      className={cx(
        "inline-flex items-center gap-2 rounded-full border px-2.5 py-1 text-[12px] shadow-sm backdrop-blur whitespace-nowrap",
        tones
      )}
    >
      {children}
  ...
  return (
    <div className="relative flex min-h-full w-full flex-col max-w-[100vw] overflow-x-hidden bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute left-0 top-0 h-[3px] w-full" style={{ backgroundImage: "linear-gradient(90deg,#0ea5e9 0%,#3b82f6 60%,transparent 100%)" }} />
        {/* Amber module wash — fades from top */}
        <div className="absolute left-0 top-[3px] h-[70%] w-full dark:hidden" style={{ backgroundImage: "linear-gradient(180deg,rgba(14,165,233,0.09) 0%,rgba(59,130,246,0.04) 38%,transparent 68%)" }} />
        <div className="absolute left-0 top-[3px] h-[70%] w-full hidden dark:block" style={{ backgroundImage: "linear-gradient(180deg,rgba(14,165,233,0.22) 0%,rgba(59,130,246,0.09) 34%,transparent 62%)" }} />
        <div className="absolute -top-44 -left-36 h-96 w-96 rounded-full bg-sky-400/28 blur-3xl dark:bg-sky-500/20" />
        <div className="absolute -bottom-44 right-[-12rem] h-[28rem] w-[28rem] rounded-full bg-amber-300/20 blur-3xl dark:bg-amber-500/14" />
        <div className="absolute top-24 right-12 h-56 w-56 rounded-full bg-blue-300/12 blur-3xl dark:bg-blue-500/8" />
      ...
      <div className="relative mx-auto w-full max-w-7xl space-y-6 px-4 pt-4 pb-10 sm:px-6 lg:px-8 lg:pt-6">
        <header className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-3 min-w-0">
            <div className="flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-amber-300/60 bg-white/80 px-3 py-1.5 text-[12px] font-medium uppercase tracking-[0.18em] text-amber-700 shadow-sm backdrop-blur dark:border-amber-400/35 dark:bg-slate-950/55 dark:text-amber-100 whitespace-nowrap">
        ...
        <section className="rounded-2xl border border-slate-200/70 bg-white/80 p-4 shadow-[0_14px_40px_-28px_rgba(2,6,23,0.55)] backdrop-blur dark:border-slate-800/60 dark:bg-slate-950/45 overflow-x-hidden">
          ...
          <div className="mt-4 rounded-2xl border border-slate-200/70 bg-white/70 p-3 shadow-sm dark:border-slate-800/60 dark:bg-slate-950/35 overflow-x-hidden">
            ...
            <div className="mt-4 rounded-xl border border-slate-200/70 bg-slate-50/70 p-3 text-[12px] text-slate-600 dark:border-slate-800/60 dark:bg-slate-900/30 dark:text-slate-300">
