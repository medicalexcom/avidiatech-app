...
export const metadata = {
  title: "Extract | AvidiaTech Product Data OS",
          ...
          <div className="rounded-[27px] border border-white/50 bg-white/75 p-4 backdrop-blur-xl dark:border-slate-800/60 dark:bg-slate-950/52 lg:p-5">
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex flex-wrap items-center gap-2">
                <div className="inline-flex items-center gap-2 rounded-full border border-amber-400/60 bg-white/80 px-3 py-1.5 text-[11px] font-medium uppercase tracking-[0.18em] text-amber-800 shadow-sm dark:border-amber-400/35 dark:bg-slate-950/45 dark:text-amber-100">
                ...
                {ingestionStatus && (
                  <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-3 py-1.5 text-[11px] text-slate-600 shadow-sm dark:border-slate-700/70 dark:bg-slate-950/45 dark:text-slate-200">
                    Status:
                    <span className="font-mono text-[10px] uppercase text-amber-700 dark:text-amber-200">
                      {ingestionStatus}
                    </span>
                  </span>
                )}
            ...
            <div className="mt-4 grid gap-4 lg:grid-cols-[minmax(0,1.15fr),minmax(0,0.85fr)] lg:items-start">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {jobId && (
                      <div className="text-right">
                        ...
                        <p className="font-mono text-[10px] text-amber-700 dark:text-amber-200">
                          {jobId.slice(0, 10)}…
                        </p>
                      </div>
                    )}
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="rounded-2xl border border-amber-200 bg-white/80 px-4 py-4 text-[11px] text-slate-700 shadow-sm dark:border-amber-500/30 dark:bg-slate-950/50 dark:text-slate-100">
                ...
                <div className="rounded-2xl border border-orange-200 bg-white/80 px-4 py-4 text-[11px] text-slate-700 shadow-sm dark:border-orange-400/30 dark:bg-slate-950/50 dark:text-slate-100">
                      ...
                      {Array.isArray(pdfUrls) && pdfUrls.length > 0 ? (
                        pdfUrls.slice(0, 8).map((u: string, i: number) => (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center gap-1 rounded-full border border-amber-300 bg-amber-50 px-3 py-1.5 text-[11px] text-amber-800 shadow-sm hover:border-amber-400 hover:text-amber-900 dark:border-amber-500/40 dark:bg-amber-500/10 dark:text-amber-200 dark:hover:border-amber-400/60"
                          >
                            <span className="text-[13px]">📄</span>
                            <span>PDF {i + 1}</span>
                          </a>
              ...
              <div className="text-right text-[11px] text-slate-500 dark:text-slate-400">
                <div>
                  {jobId ? (
                    <>
                      Job:{" "}
                      <span className="font-mono text-[10px] text-amber-700 dark:text-amber-200">
                        {jobId.slice(0, 10)}…
                      </span>
                    </>
                  ) : (
