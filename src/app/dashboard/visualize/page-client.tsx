      ...
      >
        {loading ? (
          ...
          <>
            ...
            <p className="mt-1.5 text-[12px] font-semibold text-slate-900 dark:text-slate-50">{value}</p>
          </>
        )}
      </div>
      <p className="text-center text-[12px] font-medium text-slate-800 dark:text-slate-200">{label}</p>
      <p className="text-center text-[12px] text-slate-500 dark:text-slate-400">{sublabel}</p>
    </div>
  );
}
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2">
        <p className="text-[12px] font-semibold text-slate-900 dark:text-slate-100">{title}</p>
    ...
    <PageShell glow="violet">
      ...
      <header className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-[12px] font-medium text-slate-700 shadow-sm transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
          >
      ...
      <section className="grid gap-6 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)]">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-md sm:p-5 dark:border-slate-800 dark:bg-slate-900/80">
            <div className="mb-4 flex items-center justify-between gap-2">
              ...
              <span className="inline-flex items-center gap-1 rounded-full border border-emerald-300/60 bg-emerald-50 px-2.5 py-0.5 text-[12px] text-emerald-700 dark:border-emerald-500/50 dark:bg-emerald-500/10 dark:text-emerald-200">
              ...
              <div className="space-y-4 text-sm text-slate-700 dark:text-slate-300">
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-xl border border-pink-200 bg-pink-50 p-4 dark:border-pink-500/30 dark:bg-pink-500/10">
                    <p className="text-[12px] font-medium uppercase tracking-wide text-pink-600 dark:text-pink-300">Active watches</p>
                  ...
                  <div className="rounded-xl border border-violet-200 bg-violet-50 p-4 dark:border-violet-500/30 dark:bg-violet-500/10">
                    <p className="text-[12px] font-medium uppercase tracking-wide text-violet-600 dark:text-violet-300">Events tracked</p>
                    {loading ? <Sk className="mt-2 h-7 w-14" /> : (
                      <p className="mt-1 text-2xl font-bold text-violet-700 dark:text-violet-200">{fmt(metrics?.monitor?.events)}</p>
                    )}
                  </div>
                </div>
                <p className="text-[12px] text-slate-500 dark:text-slate-400">Monitor watches track price changes, availability, and product data across connected stores. Events are recorded each time a watch triggers.</p>
              </div>
            )}

            {activeView === "coverage" && (
              <div className="flex items-center justify-center rounded-xl border border-dashed border-slate-200 py-10 text-[12px] text-slate-400 dark:border-slate-800">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50/80 px-3 py-2.5 text-[12px] text-slate-500 dark:border-slate-800 dark:bg-slate-950/60 dark:text-slate-400">
