  ...
  return (
    <PageShell glow="fuchsia">
        ...
        {packages.map((pkg) => (
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              ...
              <span className={`rounded-full px-2.5 py-0.5 text-[12px] font-semibold ${pkg.badgeColor}`}>
                {pkg.badge}
              </span>
            </div>
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white/90 p-6 shadow-card dark:border-slate-800 dark:bg-slate-900/80">
        <h3 className="mb-5 text-[12px] font-semibold uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">
          How it works
        </h3>
