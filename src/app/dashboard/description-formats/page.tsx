          ...
          >
            {fmt.recommended && (
              <div className="absolute -top-3 left-4">
                <span className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-[11px] font-semibold shadow-sm ${fmt.accentBg} ${fmt.accentText} ${fmt.accentBorder}`}>
                  Recommended
                </span>
              </div>
            )}
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className={`rounded-full px-2.5 py-0.5 text-[11px] font-semibold ${fmt.accentBg} ${fmt.accentText}`}>
                {fmt.best}
              </span>
            </div>
