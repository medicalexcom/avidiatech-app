...
export const metadata = {
  title: "Describe | AvidiaTech Product Data OS",
  description: "Generate rich, AI-powered product descriptions optimized for conversion.",
};
...
function TinyChip({
  ...
  return (
    <span
      className={cx(
        "inline-flex items-center gap-2 rounded-full border px-2.5 py-1 text-[12px] shadow-sm backdrop-blur",
        tones
      )}
    >
      {children}
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {caption ? (
          <div className="mt-2 text-[12px] leading-none text-slate-500 dark:text-slate-400">
          ...
          <div className="rounded-[27px] border border-white/50 bg-white/75 p-4 backdrop-blur-xl dark:border-slate-800/60 dark:bg-slate-950/50 lg:p-5">
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex flex-wrap items-center gap-2">
                <span className="inline-flex items-center gap-2 rounded-full border border-fuchsia-300/60 bg-white/80 px-3 py-1.5 text-[12px] font-medium uppercase tracking-[0.18em] text-fuchsia-700 shadow-sm backdrop-blur dark:border-fuchsia-400/30 dark:bg-slate-950/55 dark:text-fuchsia-100">
            ...
            <div className="mt-4 grid gap-4 lg:grid-cols-[minmax(0,1.15fr),minmax(0,0.85fr)] lg:items-start">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="rounded-2xl border border-sky-200/70 bg-white/80 p-4 text-[12px] text-slate-700 shadow-sm dark:border-sky-500/25 dark:bg-slate-950/45 dark:text-slate-100">
                    <div className="text-[12px] font-medium uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">
                      Example input
                    </div>
                  ...
                  <div className="rounded-2xl border border-emerald-200/70 bg-white/80 p-4 text-[12px] text-slate-700 shadow-sm dark:border-emerald-500/25 dark:bg-slate-950/45 dark:text-slate-100">
                    <div className="text-[12px] font-medium uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">
                      Typical output
                    </div>
        ...
        <section className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-8">
            <div className="rounded-2xl border border-slate-200/70 bg-white/80 p-4 shadow-[0_14px_46px_-30px_rgba(2,6,23,0.55)] backdrop-blur dark:border-slate-800/60 dark:bg-slate-950/45">
              ...
              {/* ✅ NEW: the preview scroll behavior now lives INSIDE DescribeOutput.
                  Do NOT wrap it in additional scroll shells/scripts here, or you’ll reintroduce double scrollbars.
                  Keeping this container simple ensures both Styled & HTML Viewer behave the same (one scroll, sticky band). */}
              <div className="mt-4">
                <DescribeOutput />
              </div>
            </div>
          ...
          <aside className="space-y-4 lg:col-span-4">
            <div className="rounded-2xl border border-slate-200/70 bg-white/80 p-4 shadow-[0_14px_40px_-28px_rgba(2,6,23,0.55)] backdrop-blur dark:border-slate-800/60 dark:bg-slate-950/45">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="rounded-xl border border-slate-200/70 bg-white/75 p-3 text-[12px] shadow-sm dark:border-slate-800/60 dark:bg-slate-950/35">
                  <div className="text-[12px] uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
                    Output includes
                  </div>
            ...
            <div className="rounded-2xl border border-amber-200/70 bg-white/80 p-4 text-[12px] text-slate-700 shadow-sm dark:border-amber-500/25 dark:bg-slate-950/45 dark:text-slate-100">
              <div className="text-[12px] font-medium uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">
                Quality checklist
              </div>
              <ul className="mt-2 list-inside list-disc space-y-1">
