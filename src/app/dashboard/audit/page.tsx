  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-32 -left-24 h-72 w-72 rounded-full bg-amber-500/25 blur-3xl" />
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="space-y-3 max-w-2xl">
                <div className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-950/90 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.18em] text-slate-300">
                  ...
                  <span className="text-amber-200">Quality &amp; compliance engine</span>
                </div>
                ...
                <div className="rounded-2xl border border-slate-800 bg-slate-950/90 px-4 py-3">
                  ...
                  <div className="space-y-2 text-[11px]">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/10 border border-emerald-400/70 px-2 py-0.5 text-xs font-semibold text-emerald-300">
                        94 / 100
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-slate-400">
                      <span>Structure &amp; SEO</span>
                      <span className="text-emerald-300 font-medium">OK</span>
                    </div>
                    <div className="flex items-center justify-between text-slate-400">
