...
function ProgressRing({ value }: { value: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 grid place-items-center text-[12px] font-semibold text-slate-700 dark:text-slate-200">
        {v}%
      </div>
    </div>
  );
    ...
    <PageShell glow="rose">
        ...
        <section className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-2">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/90 px-3 py-1.5 text-[12px] font-medium uppercase tracking-[0.18em] text-slate-600 shadow-sm dark:border-slate-800 dark:bg-slate-950/70 dark:text-slate-300">
              ...
              {ingestionId ? (
                <>
                  ...
                  <button
                    ...
                    className="font-mono text-[12px] text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white"
          ...
          <div className="flex flex-wrap items-center gap-2">
            {statusMessage ? (
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1.5 text-[12px] text-amber-900 shadow-sm dark:border-amber-500/30 dark:bg-slate-950/70 dark:text-amber-100">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white/90 px-3 py-1.5 text-[12px] text-slate-700 shadow-sm hover:bg-white disabled:opacity-60 dark:border-slate-800 dark:bg-slate-950/60 dark:text-slate-200 dark:hover:bg-slate-950"
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white/90 px-3 py-1.5 text-[12px] text-slate-700 shadow-sm hover:bg-white dark:border-slate-800 dark:bg-slate-950/60 dark:text-slate-200 dark:hover:bg-slate-950"
            >
          ...
          <div className="grid grid-cols-1 gap-4 p-4 lg:grid-cols-12 lg:gap-5 lg:p-5">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm dark:border-slate-800 dark:bg-slate-950/50">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="text-[12px] font-medium uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
                    Run mode
                  </div>

                  <div className="inline-flex rounded-full border border-slate-200 bg-slate-50 p-1 text-[12px] dark:border-slate-800 dark:bg-slate-950/60">
                    <button
                      type="button"
                      className={cx(
                ...
                {mode === "url" ? (
                  <div className="mt-3 space-y-2">
                    <label className="text-[12px] font-medium uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <button
                        type="button"
                        className="text-[12px] text-orange-700 hover:text-orange-600 underline underline-offset-4 dark:text-orange-300 dark:hover:text-orange-200"
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <div className="inline-flex items-center gap-2 text-[12px] text-slate-600 dark:text-slate-300">
                        ...
                        <select
                          ...
                          className="rounded-lg border border-slate-200 bg-white px-2 py-1 text-[12px] dark:border-slate-800 dark:bg-slate-950/60"
                        >
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          type="button"
                          className="text-[12px] text-slate-500 hover:text-slate-700 underline underline-offset-4 dark:text-slate-400 dark:hover:text-slate-200"
                          onClick={async () => {
                            try {
                              setError(null);
            ...
            <div className="lg:col-span-5">
              <div className="rounded-2xl border border-slate-200 bg-slate-50/90 p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950/60">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2">
                      ...
                      {blockersCount ? (
                        <span className="inline-flex items-center gap-2 rounded-full border border-rose-200 bg-rose-50 px-2.5 py-1 text-[12px] text-rose-800 dark:border-rose-500/30 dark:bg-rose-950/40 dark:text-rose-100">
                          <span className="h-1.5 w-1.5 rounded-full bg-rose-500" />
                          {blockersCount} blockers
                        </span>
                      ) : (
                        <span className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-2.5 py-1 text-[12px] text-emerald-800 dark:border-emerald-500/30 dark:bg-emerald-950/35 dark:text-emerald-100">
                      ...
                      {warningsCount ? (
                        <span className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-[12px] text-amber-800 dark:border-amber-500/30 dark:bg-amber-950/35 dark:text-amber-100">
                ...
                {/* Gate status */}
                <div className="mt-4 rounded-xl border border-slate-200 bg-white px-3 py-2 text-[12px] text-slate-700 dark:border-slate-800 dark:bg-slate-950/40 dark:text-slate-200">
                ...
                {showRawAuditJson ? (
                  <pre className="mt-3 max-h-[320px] overflow-auto rounded-xl border border-slate-200 bg-slate-900 p-3 text-[12px] text-slate-100 dark:border-slate-800">
                    {JSON.stringify(downloadableAuditJson, null, 2)}
                  </pre>
                ) : null}

                <div className="mt-4 flex items-center justify-between text-[12px] text-slate-500 dark:text-slate-400">
          ...
          <div className="lg:col-span-5 rounded-3xl border border-slate-200 bg-white/92 p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950/55">
            ...
            <div className="mt-4 space-y-2">
                  ...
                  >
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={cx(
                            "ml-auto inline-flex items-center rounded-full border px-2 py-0.5 text-[12px]",
                      ...
                      <div className="mt-1.5 flex flex-wrap items-center gap-2 text-[12px] text-slate-500 dark:text-slate-400">
                        ...
                        {m.output_ref ? (
                          <button
                            ...
                            className="ml-auto rounded-full border border-slate-200 bg-white px-2 py-0.5 text-[12px] text-slate-600 shadow-sm hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950/40 dark:text-slate-300 dark:hover:bg-slate-950"
                      ...
                      {m.error ? (
                        <div className="mt-1 text-[12px] text-rose-700 dark:text-rose-200">
              ...
              {!(pipelineSnapshot?.modules ?? []).length ? (
                <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-4 py-4 text-[12px] text-slate-500 dark:border-slate-800 dark:bg-slate-950/40 dark:text-slate-400">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <input
                    ...
                    className="w-44 rounded-lg border border-slate-200 bg-white px-2 py-1 text-[12px] dark:border-slate-800 dark:bg-slate-950/60"
                  />
                </div>
              </div>
                      ...
                      filteredIssues.map((i, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-3 py-2 font-mono text-[12px] text-slate-700 dark:text-slate-200">
                              {String(i?.rule ?? i?.key ?? "—")}
                            </td>
          ...
          <section className="grid grid-cols-1 gap-4 lg:grid-cols-12">
            <div className="lg:col-span-6 rounded-3xl border border-slate-200 bg-white/92 p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950/55">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[12px] text-slate-500 dark:text-slate-400">Ingestion</span>
              </div>
              <pre className="mt-3 whitespace-pre-wrap break-words rounded-2xl border border-slate-800 bg-slate-900/95 p-3 text-[12px] text-slate-100 dark:bg-slate-950/70">
                {jobData
            ...
            <div className="lg:col-span-6 rounded-3xl border border-slate-200 bg-white/92 p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950/55">
              <div className="flex items-center justify-between">
                ...
                {pollingState ? (
                  <span className="text-[12px] text-slate-500 dark:text-slate-400">{pollingState}</span>
                ) : null}
              </div>
              <pre className="mt-3 whitespace-pre-wrap break-words rounded-2xl border border-slate-800 bg-slate-900/95 p-3 text-[12px] text-slate-100 dark:bg-slate-950/70">
