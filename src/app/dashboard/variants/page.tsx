...
// ─── Sample data ──────────────────────────────────────────────────────────────
const SAMPLE_FAMILIES: VariantFamily[] = [
  {
    id: "vf-001",
    parentName: "ProBasics Folding Walker",
    sku: "PB-WALK",
    options: [
      { name: "Height", values: ["Standard (29–37 in)", "Tall (32–39 in)", "Youth (24–32 in)"] },
      { name: "Wheel type", values: ["No wheels (standard)", "2-wheel front glide", "4-wheel rollator"] },
    ],
    members: [
      { sku: "PB-WALK-STD", name: "ProBasics Folding Walker, Standard", attrs: { Height: "Standard (29–37 in)", "Wheel type": "No wheels (standard)" } },
      { sku: "PB-WALK-TALL", name: "ProBasics Folding Walker, Tall", attrs: { Height: "Tall (32–39 in)", "Wheel type": "No wheels (standard)" } },
      { sku: "PB-WALK-2W", name: "ProBasics Folding Walker with 2 Wheels", attrs: { Height: "Standard (29–37 in)", "Wheel type": "2-wheel front glide" } },
    ],
    approved: false,
  },
  {
    id: "vf-002",
    parentName: "Omron Blood Pressure Monitor",
    sku: "OM-BP",
    options: [
      { name: "Cuff size", values: ["Small/Medium (9–13 in)", "Large (13–17 in)", "Extra Large (17–21 in)"] },
      { name: "Connectivity", values: ["Standard", "Bluetooth Smart"] },
    ],
    members: [
      { sku: "OM-BP-SM-BT", name: "Omron BP Monitor, S/M Cuff, Bluetooth", attrs: { "Cuff size": "Small/Medium (9–13 in)", Connectivity: "Bluetooth Smart" } },
      { sku: "OM-BP-LG-STD", name: "Omron BP Monitor, Large Cuff, Standard", attrs: { "Cuff size": "Large (13–17 in)", Connectivity: "Standard" } },
    ],
    approved: true,
  },
  {
    id: "vf-003",
    parentName: "Medline Wound Dressing",
    sku: "MDL-WND",
    options: [
      { name: "Type", values: ["Hydrocolloid", "Foam non-adhesive", "Transparent film"] },
      { name: "Size", values: ["2×2 in", "4×4 in", "6×6 in"] },
    ],
    members: [
      { sku: "MDL-WND-HC-4", name: "Medline Hydrocolloid Dressing 4×4 in", attrs: { Type: "Hydrocolloid", Size: "4×4 in" } },
      { sku: "MDL-WND-FM-4", name: "Medline Foam Dressing 4×4 in", attrs: { Type: "Foam non-adhesive", Size: "4×4 in" } },
      { sku: "MDL-WND-TF-6", name: "Medline Transparent Film 6×6 in", attrs: { Type: "Transparent film", Size: "6×6 in" } },
    ],
    approved: false,
  },
];
...
export default function VariantsPage() {
  const [families, setFamilies] = useState<VariantFamily[]>(SAMPLE_FAMILIES);
  ...
  async function runDetection() {
    ...
    setRunning(false);
    showToast("Variant detection complete — 3 families proposed.");
  }
