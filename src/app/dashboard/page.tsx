  ...
  return (
    <div className="relative flex min-h-full w-full flex-col overflow-hidden bg-slate-50 text-slate-900 dark:bg-[#060c1a] dark:text-slate-50">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        {/* Dot grid — light mode */}
        <div className="absolute inset-0 dark:hidden" style={{ backgroundImage: "radial-gradient(rgba(100,116,139,0.35) 1px,transparent 1px)", backgroundSize: "28px 28px" }} />
        {/* Dot grid — dark mode */}
        <div className="absolute inset-0 hidden dark:block" style={{ backgroundImage: "radial-gradient(rgba(100,116,139,0.25) 1px,transparent 1px)", backgroundSize: "28px 28px" }} />
        {/* Bottom vignette */}
