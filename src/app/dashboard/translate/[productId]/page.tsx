  ...
  return (
    <div className="relative flex min-h-full w-full flex-col bg-slate-50 dark:bg-slate-950 dark:text-slate-50 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-20 -left-16 h-64 w-64 rounded-full bg-sky-400/28 blur-3xl dark:bg-sky-500/20" />
        <div className="absolute bottom-0 right-[-8rem] h-72 w-72 rounded-full bg-blue-300/18 blur-3xl dark:bg-blue-500/12" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl space-y-6 px-4 py-6 sm:px-6 lg:px-10 lg:py-8">
        ...
        <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-1.5">
            ...
            <p className="text-[12px] font-mono text-slate-400 dark:text-slate-600">{productId}</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              {selectedLangs.length === 0 && (
                <p className="mt-2 text-[12px] text-rose-500 dark:text-rose-400">Select at least one language</p>
              )}
            </div>
                  ...
                  return (
                    <div key={lang} className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                      ...
                      <div className="divide-y divide-slate-100 dark:divide-slate-800/60 px-5">
                        {payload.name && (
                          <div className="py-3">
                            <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-slate-400 dark:text-slate-600 mb-1">Name</p>
                            <p className="text-sm text-slate-800 dark:text-slate-100">{payload.name}</p>
                          </div>
                        )}
                        {payload.description_html && (
                          <div className="py-3">
                            <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-slate-400 dark:text-slate-600 mb-1">Description</p>
                            <div
                        ...
                        {payload.features && payload.features.length > 0 && (
                          <div className="py-3">
                            <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-slate-400 dark:text-slate-600 mb-1">Key features</p>
