    ...
    <PageShell glow="sky">
        ...
        <section className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-3">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-sky-300 bg-white/90 px-3 py-1.5 text-[12px] font-medium uppercase tracking-[0.18em] text-sky-700 shadow-sm dark:border-sky-500/60 dark:bg-slate-950/90 dark:text-sky-100">
          ...
          <div className="mt-3 w-full max-w-sm rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-slate-950/85">
            <p className="text-[12px] font-medium uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
              Workspace snapshot
            </p>
            <div className="mt-3 grid gap-3 text-xs">
              <div className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2.5 dark:bg-slate-900/70">
                ...
                <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/10 px-2.5 py-1 text-[12px] font-medium text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-200">
              ...
              <div className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2.5 dark:bg-slate-900/70">
                ...
                <span className="inline-flex items-center gap-1 rounded-full bg-sky-500/10 px-2.5 py-1 text-[12px] font-medium text-sky-700 dark:bg-sky-500/15 dark:text-sky-200">
                  <span className="h-1.5 w-1.5 rounded-full bg-sky-500" />
                  Multi-region
                </span>
              </div>
              <p className="rounded-xl bg-gradient-to-r from-sky-100 via-fuchsia-100 to-emerald-100 px-3 py-2 text-[12px] text-slate-800 dark:from-sky-500/15 dark:via-fuchsia-500/10 dark:to-emerald-500/10 dark:text-slate-100">
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1.5fr),minmax(320px,0.9fr)]">
          ...
          <div className="space-y-4 rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-slate-950/80">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex flex-col items-end gap-2 sm:flex-row sm:items-center">
                ...
                <div className="hidden items-center rounded-full bg-slate-100 px-3 py-1 text-[12px] text-slate-600 dark:bg-slate-900/60 dark:text-slate-300 sm:flex">
                  <span className="mr-1 text-slate-500 dark:text-slate-400">
                    Filter:
                  </span>
                  <button
                    type="button"
                    className="mr-1 rounded-full bg-white px-2 py-0.5 text-[12px] font-medium shadow-sm dark:bg-slate-800 dark:text-slate-100"
                  >
                    All
                  </button>
                  <button
          ...
          <div className="space-y-4 self-start lg:sticky lg:top-24">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-slate-950/80">
              ...
              <h4 className="mt-4 text-[12px] font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">
