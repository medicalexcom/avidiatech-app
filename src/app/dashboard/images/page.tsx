            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="space-y-3 max-w-2xl">
                <div className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-950/90 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.18em] text-slate-300">
                  ...
                  <span className="text-emerald-200">Gallery &amp; variant mapping engine</span>
                </div>

                <div className="space-y-2">
                  <h1 className="text-2xl sm:text-3xl font-semibold text-slate-50">
                    Turn noisy product image carousels into{" "}
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-300 via-teal-300 to-sky-300">
                ...
                <div className="flex flex-wrap gap-3 text-[11px]">
                  <div className="inline-flex items-center gap-2 rounded-full bg-slate-950/90 border border-emerald-500/60 px-3 py-1.5">
                    ...
                    <span className="text-slate-200">De-duplicate and normalize all product imagery.</span>
                  </div>
                  ...
                  <div className="inline-flex items-center gap-2 rounded-full bg-slate-950/90 border border-amber-500/55 px-3 py-1.5">
                ...
                <div className="rounded-2xl border border-slate-800 bg-slate-950/90 px-4 py-3">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {Array.from({ length: 8 }).map((_, i) => (
                      <div
                        key={i}
                        className="aspect-square rounded-lg border border-slate-800 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950 flex items-center justify-center text-[9px] text-slate-500"
                      >
                        {i === 0 ? "Main" : i === 1 ? "Zoom" : i === 2 ? "Context" : "Img"}
                      </div>
                    ))}
                  </div>
