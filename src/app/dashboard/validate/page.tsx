        ...
        right={
          <div className="flex gap-2">
            ...
            <Link
              ...
              className="inline-flex h-8 items-center gap-1.5 rounded-lg bg-emerald-600 px-4 text-[13px] font-semibold text-white shadow-sm transition hover:bg-emerald-700"
            >
              Run validation
            </Link>
          </div>
