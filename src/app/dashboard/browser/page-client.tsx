              ...
              <div className="rounded-2xl border border-slate-200 bg-white/95 shadow-[0_16px_40px_rgba(148,163,184,0.25)] dark:border-slate-800 dark:bg-slate-900/85 overflow-hidden">
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2 border-t border-slate-100 pt-3 dark:border-slate-800">
                    <button onClick={sendToAvidia} className="inline-flex flex-1 items-center justify-center rounded-full bg-cyan-500 px-3 py-2 text-[11px] font-semibold text-white shadow-sm hover:bg-cyan-400">
              ...
              <div className="mt-3 space-y-1.5 text-[11px]">
                {["Install Chrome extension", "Log in with AvidiaTech account", "Browse any product page", "Click Capture → Send to Avidia"].map((step, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <span className="inline-flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-cyan-100 text-[10px] font-semibold text-cyan-700 dark:bg-cyan-500/20 dark:text-cyan-300">{i + 1}</span>
                    <span className="text-slate-600 dark:text-slate-300">{step}</span>
                  </div>
                ))}
              </div>
              <button className="mt-3 w-full rounded-lg border border-cyan-300/60 bg-cyan-50 py-2 text-[11px] font-medium text-cyan-700 transition hover:bg-cyan-100 dark:border-cyan-500/40 dark:bg-cyan-500/10 dark:text-cyan-300">
