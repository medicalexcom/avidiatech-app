            ...
            <div className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-[0_18px_45px_rgba(148,163,184,0.35)] sm:p-5 dark:border-slate-800 dark:bg-slate-900/85 dark:shadow-[0_18px_45px_rgba(15,23,42,0.7)]">
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-600 dark:text-slate-300">
                <li className="flex gap-2">
                  ...
                  <span>
                    <span className="font-medium">On-page extraction:</span> click the
                    extension to extract product details—title, specs, images, manuals,
                    and more—from the current page and preview them instantly.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="mt-1 inline-flex h-1.5 w-1.5 rounded-full bg-violet-400" />
                ...
                <li className="flex gap-2">
                  <span className="mt-1 inline-flex h-1.5 w-1.5 rounded-full bg-violet-400" />
                  <span>
                    <span className="font-medium">Quick export mode:</span> download
                    CSV/JSON payloads locally when you just need a fast one-off capture
                    outside of the AvidiaTech pipeline.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="mt-1 inline-flex h-1.5 w-1.5 rounded-full bg-violet-400" />
            ...
            <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50/90 p-4 dark:border-slate-800 dark:bg-slate-950/70">
              ...
              <ul className="mt-2 space-y-1.5 text-xs text-slate-600 dark:text-slate-400">
                <li>
                  ...
                  — treat browser captures as first-class ingest jobs so they can flow
                  through the same normalization and QA steps.
                </li>
                <li>
                  •{" "}
                  <span className="font-medium text-slate-800 dark:text-slate-200">
                ...
                <li>
                  ...
                  — advanced users can route extension captures into custom workflows via
                  webhooks or direct API endpoints.
                </li>
              </ul>
              <p className="mt-3 text-[10px] text-slate-500 dark:text-slate-500">
                Over time, AvidiaBrowser becomes your fastest way to turn &quot;I found
                this product online&quot; into a fully structured, ready-to-sell item
                inside AvidiaTech.
              </p>
            </div>
          </div>
