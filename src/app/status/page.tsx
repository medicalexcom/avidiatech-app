...
export default function StatusPage() {
  ...
  return (
    <main className="dark relative min-h-[100dvh] bg-slate-950 text-slate-100 overflow-hidden">
      {/* Ambient glow */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 right-[-5%] h-[400px] w-[400px] rounded-full bg-emerald-500/8 blur-[120px]" />
        <div className="absolute bottom-0 left-[-5%] h-[300px] w-[300px] rounded-full bg-cyan-500/8 blur-[100px]" />
      ...
      {/* Top stripe */}
      <div className="absolute top-0 left-0 right-0 h-[2px]" style={{ background: "linear-gradient(90deg,#10b981 0%,#06b6d4 100%)" }} />
      {/* Banner */}
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-10">
        ...
        <section className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 text-center">
          ...
          <p className="text-xs text-slate-400 mt-3">
            Questions? Contact{" "}
            <a href="mailto:support@avidiatech.com" className="text-cyan-600 hover:underline">
