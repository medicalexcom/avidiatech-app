          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-200">
                ...
                Supabase tracks tenants, and Stripe handles upgrades so your team can ship features—not boilerplate.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <SignedOut>
                <>
                  <SignUpButton afterSignUpUrl="/dashboard" afterSignInUrl="/dashboard">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl space-y-2">
              ...
              <p className="text-base text-slate-200">
                ...
                rules, usage counters, and subscription checks that guard premium actions while still
                logging activity.
              </p>
            </div>
