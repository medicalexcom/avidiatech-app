  ...
  if (type === "timer") return (
    <div className="flex flex-col items-center gap-2 py-2">
      <div className="relative flex h-16 w-16 items-center justify-center rounded-full border-4"
        ...
        <span className="text-[11px] font-bold tabular-nums" style={{ color }}>1:47</span>
      </div>
      <span className="text-[11px] font-semibold text-slate-500">avg. per product</span>
    </div>
  );
                ...
                <div className="relative overflow-hidden rounded-[24px] border border-white/70 bg-white/95 shadow-2xl shadow-slate-900/14 backdrop-blur dark:border-slate-700/50 dark:bg-slate-900/96">
                  ...
                  <div className="p-5 space-y-1">
                    ...
                    <div className="flex items-center gap-2.5 rounded-xl border border-slate-200/80 bg-slate-50 px-3.5 py-2.5 dark:border-slate-700 dark:bg-slate-800/60">
                      ...
                      <span className="font-mono text-[11px] text-slate-600 dark:text-slate-400 truncate">vendor.com/products/pump-9000</span>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2.5">
                              ...
                              <div>
                                ...
                                <div className="text-[10px] text-slate-500 dark:text-slate-400">{node.badge}</div>
                              </div>
                            </div>
                    ...
                    <div className="flex items-center gap-3 rounded-xl border border-emerald-200/60 bg-emerald-50/80 px-4 py-3 dark:border-emerald-500/25 dark:bg-emerald-500/8">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-emerald-600/70 dark:text-emerald-400/60">Title · Meta · H1 · Structured data · Feeds</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  {HOW_IT_WORKS.map((step, i) => (
                    <div key={step.step}
                      ...
                      <div className="mb-5 flex items-center gap-3">
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border-2 text-[11px] font-extrabold tracking-wider"
          ...
          <div className={`stagger grid gap-6 md:grid-cols-3 ${moments.on ? "on" : ""}`}>
            {MOMENTS.map((m) => (
              <div key={m.tag}
                ...
                {/* Tag */}
                <span className="inline-block rounded-full px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.18em]"
                ...
                <div className="rounded-2xl border border-slate-200/80 bg-white shadow-xl shadow-slate-900/8 dark:border-slate-800 dark:bg-slate-900">
                  ...
                  <div className="space-y-3.5 p-5">
                    <div>
                      ...
                      {demoErr && <p className="mt-1 text-[11px] text-rose-600">{demoErr}</p>}
                    </div>

                    <div>
                      <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-[0.16em] text-slate-400">AI output · Describe step</label>
            ...
            <div className="relative overflow-hidden rounded-[28px] px-8 py-20 text-center sm:px-16 sm:py-24"
              ...
              <div className="pointer-events-none absolute inset-0">
                ...
                {[["Extract","#f59e0b","left-8 top-12"],["Describe","#8b5cf6","right-10 top-16"],["Monitor","#0ea5e9","left-14 bottom-10"],["Feeds","#f97316","right-8 bottom-12"]].map(([n,c,pos]) => (
                  <div key={n} className={`absolute ${pos} hidden xl:flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-3 py-1.5 text-[11px] font-semibold text-white backdrop-blur-sm`}
