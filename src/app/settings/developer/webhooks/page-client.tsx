    ...
    return (
      <div className="space-y-6">
        <div className="border-b border-slate-200 pb-5 dark:border-slate-800">
          <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-50">Webhooks</h1>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-[12px] text-amber-700 dark:text-amber-400">
                You are not authorized to manage webhooks. Contact your workspace owner or admin.
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-slate-200 pb-5 dark:border-slate-800">
        ...
        <p className="mt-1 text-[13px] text-slate-500 dark:text-slate-400">
          Configure webhooks to receive real-time notifications for pipeline events and job completions.
        </p>
      </div>
